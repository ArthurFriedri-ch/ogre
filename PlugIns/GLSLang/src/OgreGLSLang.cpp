    ...
    : HighLevelGpuProgram(creator, name, handle, group, isManual, loader)
{
    if (createParamDictionary("glslangProgram"))
    {
        ...
        dict->addParameter(ParameterDef("descriptor_set_profile", "Descriptor set profile override, "
                                          "forwarded as-is to the delegate program.", PT_STRING), &msCmdDescriptorSetProfile);
